...
class Bounce(Feedback):
    ...
    def __str__(self):
        ...
        return f"{self.address} {self.bounce_type} Bounce (message from {self.mail_from})"
...
class Complaint(Feedback):
    ...
    def __str__(self):
        ...
        return f"{self.address} Complaint (email sender: from {self.mail_from})"
...
class Delivery(Feedback):
    ...
    def __str__(self):
        ...
        return f"{self.address} Delivery (email sender: from {self.mail_from})"
